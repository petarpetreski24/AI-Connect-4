...
# noinspection PyShadowingNames
def minimax_AI2(board, depth, alpha, beta, maximizingPlayer): #TO FIX
...
while not game_over:
    if turn == AI1_PIECE and not game_over:
        ...
        turn = AI2_PIECE
        col, minimax_score = minimax_AI1(board, 6, -math.inf, math.inf, True)
        ...
        turn = AI1_PIECE
        col, minimax_score = minimax_AI2(board, 6, -math.inf, math.inf, True)
